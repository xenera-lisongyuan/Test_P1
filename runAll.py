...
# os.system("python ./test_ui_chrome1.py")
# os.system("python ./test_api_get2.py")
# os.system("python ./test_api_post1.py")
# os.system("python ./test_api_post2.py")
# os.system("python ./test_pytest2.py")
# os.system("python ./test_pytest3.py")

if __name__ == '__main__':
    """Please use this file to start all the test cases. Then the results will be published with Allure Report"""
    pytest.main()
    time.sleep(2)
    os.system("pytest test_pytest2.py -vs --alluredir=./report  --clean-alluredir")
